...
export default class Game extends Phaser.Scene {
  ...
  private handleKnifeLizardCollision(
    ...
    //disableBody instead of killAndHide https://photonstorm.github.io/phaser3-docs/Phaser.Physics.Arcade.Sprite.html#disableBody__anchor
  }
  ...
  // total time, delta time (change in time to last frame)
